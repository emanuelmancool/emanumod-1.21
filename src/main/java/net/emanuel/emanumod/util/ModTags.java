...
public class ModTags {
    ...
    public static class Items {
        public static final TagKey<Item> GREEN_PAPER_ENCHANTABLE = createTag("green_paper_enchantable");
    }

    private static TagKey<Item> createTag(String name) {
        return TagKey.of(RegistryKeys.ITEM, Identifier.of(Emanumod.MOD_ID, name));
    }
}
