...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> E = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(Emanumod.MOD_ID, "e"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.E_SMITHING_TEMPLATE, E);
    }
