package net.emanuel.emanumod.item.custom;

import com.google.common.collect.ImmutableMap;
import net.emanuel.emanumod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.GREEN_IRON_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.SATURATION, 400, 0, false, false),
